        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" id="register" novalidate="true">
                            @csrf
                            <div class="row">
                                <div class="form-group ">
                                    <label for="first_name" class="col-md-12 col-form-label text-md-right">First
                                        Name</label>
                                ...
                                <div class="form-group ">
                                    <label for="last_name"
                                           class="col-md-12 col-form-label text-md-right">Last Name</label>
